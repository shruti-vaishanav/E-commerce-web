...
import { filters } from '../../constant/common';
...
export default function SidebarFilter({ children }: any) {
      ...
      <div>
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    ...
                    {filters.map((section) => (
                      <Disclosure as="div" key={section.id} className="border-t border-gray-200 px-4 py-5">
                        {({ open }) => (
                          <>
        ...
        <main className="mx-auto max-w-9xl px-4 sm:px-6 lg:px-6">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-2 gap-x- gap-y-10 lg:grid-cols-4">
              {/* Filters */}
